...
namespace EcommerceProject2API.DAL.Migrations
{
    ...
    [Migration("20260523113829_Reviews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceProject2API.DAL.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EcommerceProject2API.DAL.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceProject2API.DAL.Models.OrderItem", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceProject2API.DAL.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceProject2API.DAL.Models.OrderItem", b =>
                {
                    b.HasOne("EcommerceProject2API.DAL.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EcommerceProject2API.DAL.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
